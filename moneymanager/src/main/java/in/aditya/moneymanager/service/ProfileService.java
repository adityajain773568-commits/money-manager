...
public class ProfileService {
    ...
    public ProfileEntity getCurrentProfile(){
        ...
        return profileRepository.findByEmail(authentication.getName()).orElseThrow(()->new UsernameNotFoundException("Cant find user with email = " + authentication.getName()));
    }
    ...
    public ProfileDTO getPublicProfile(String email){
        ...
        if (email==null){
            ...
            currentUser = profileRepository.findByEmail(email).orElseThrow(()->new UsernameNotFoundException("Cant find user with email = " + email));
        }
